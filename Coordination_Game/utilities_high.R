...
.matchH = function(f1, f2, n = 2000, t = 5, r = 3, p = 1, s = 0, n.min = 100,
                  n.max = 1000) {
...
.tournamentH = function(x, n = 2000, t = 5, r = 3, p = 1, s = 0, n.min = 100,
                       n.max = 1000) {
  ...
  for (i in 1:nrow(I)) {
    j <- I[i, 1]
    k <- I[i, 2]
    z <- .matchH(x[[j]], x[[k]], n, t, r, p, s, n.min, n.max)
